...
describe("Bank contract", function () {
    ...
    describe("Bank", function () {
        ...
        it("should emmit deposit event", async function () {
            ...
            await expect(
                hardhatBank.connect(addr1).deposit({
        ...
        it("should throw an error for insufficient balance", async function () {
            ...
            await expect(hardhatBank.connect(addr1).withdraw(ZERO_POINT_TWO)).to.be.revertedWith(
        ...
        it("should emmit InTransfer event", async function () {
            ...
            await expect(
                hardhatBank.connect(addr1).inBankTransfer("987654321098", ZERO_POINT_ZERO_FIVE),
            )
        ...
        it("should throw an error for invalid account number during in-bank transfer", async function () {
            ...
            await expect(
                hardhatBank
                    .connect(addr1)
                    .inBankTransfer("invalid-account-number", ZERO_POINT_ZERO_FIVE),
